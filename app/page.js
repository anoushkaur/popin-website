  ...
  return (
    <>
      ...
      <section className="section" id="about" aria-label="What is PopIn">
        ...
        <img className="wh-heart h1" src="/networking.png" alt="network" />
        <img className="wh-heart h2" src="/networking.png" alt="network" />
        <img className="wh-heart h3" src="/networking.png" alt="network" />
        <img className="wh-heart h4" src="/networking.png" alt="network" />
        <img className="wh-heart h5" src="/networking.png" alt="network" />
        <img className="wh-heart h6" src="/networking.png" alt="network" />
        <img className="wh-heart h7" src="/networking.png" alt="network" />
        ...
        <div className="grid-boxes-section">
          <div className="grid-boxes-container">
            <div className="grid-box image-box" style={{backgroundImage: 'url(/handshake.png)'}}></div>
            ...
            <div className="grid-box image-box" style={{backgroundImage: 'url(/communicating.png)'}}></div>
            <div className="grid-box coral-box">
              <p>Find the Perfect Connection</p>
            </div>
            <div className="grid-box image-box" style={{backgroundImage: 'url(/talking.png)'}}></div>
          </div>
        </div>
      </section>
    </>
